...
public class ClassLoaderManager {
    ...
    private static Map<String, YjpClassLoader> pluginClassLoader = new ConcurrentHashMap<>();
    ...
    private static YjpClassLoader retrieveClassLoad(String pluginJarPath) {
        return pluginClassLoader.computeIfAbsent(pluginJarPath, k -> {
            try {
                URL[] urls = PluginUtil.getPluginJarUrls(pluginJarPath);
                ClassLoader parentClassLoader = Thread.currentThread().getContextClassLoader();
                YjpClassLoader classLoader = new YjpClassLoader(urls, parentClassLoader);
    ...
    private static YjpClassLoader retrieveClassLoad(List<URL> jarUrls) {
    ...
    public static List<URL> getClassPath() {
        ...
        for (Map.Entry<String, YjpClassLoader> entry : pluginClassLoader.entrySet()) {
