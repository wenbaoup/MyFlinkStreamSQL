...
public class PluginUtil {
    ...
    private static final String CLASS_PRE_STR = "com.yjp.flink.sql";
    ...
    public static void addPluginJar(String pluginDir, YjpClassLoader classLoader) throws MalformedURLException {
