...
public class YjpClassLoader extends URLClassLoader {

    private static Logger log = LoggerFactory.getLogger(YjpClassLoader.class);
    ...
    public YjpClassLoader(URL[] urls, ClassLoader parent) {
        super(urls, parent);
        this.parent = parent;
    }

    public YjpClassLoader(URL[] urls) {
        super(urls);
    }

    public YjpClassLoader(URL[] urls, ClassLoader parent, URLStreamHandlerFactory factory) {
