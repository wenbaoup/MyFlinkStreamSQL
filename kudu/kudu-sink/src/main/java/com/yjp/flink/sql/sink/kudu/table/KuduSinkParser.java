package com.yjp.flink.sql.sink.kudu.table;

import com.yjp.flink.sql.sink.kudu.KuduOutputFormat;
...
import static com.yjp.flink.sql.table.TableInfo.PARALLELISM_KEY;
